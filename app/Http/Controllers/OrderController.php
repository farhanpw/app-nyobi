...
class OrderController extends Controller
{
    ...
    {
        return view('admin.ordered.index');
    }

    public function dikonfirmasi_list()
    {
        return view('admin.ordered.confirmed');
    }

    public function dikemas_list()
    {
        return view('admin.ordered.packed');
    }
    public function dikirim_list()
    {
        return view('admin.ordered.sent');
    }
    public function diterima_list()
    {
        return view('admin.ordered.recived');
    }
    public function selesai_list()
    {
        return view('admin.ordered.completed');
    }
    ...
    public function store(Request $request)
    {
        ...
        for ($i = 0; $i < count($input['id_poroduk']); $i++) {
            OrderDetail::create([
                'id_order' => $Order['id'],
