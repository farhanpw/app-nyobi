            ...
            <div class="col-md-12">
                <form class="form-Slider">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="name_slider" placeholder="Nama Slider">
                    </div>
                    <div class="form-group">
                        <label>Deskripsi</label>
                        <textarea name="description" placeholder="Deskripsi" class="form-control" id="" cols="30" rows="10"></textarea>
                    </div>
                    <div class="form-group">
                        <label >Gambar</label>
    ...
    $(document).ready(function() {
        $('#tbl_list').DataTable({
            ...
            columns: [{data: 'id', name: 'id'},
                {data: 'name_slider', name: 'name_slider'},
            ...
            $(document).on('click', '.modal-ubah', function(){
                ...
                $.get('/api/sliders/' + id, function({data}){
                    $('input[name="name_slider"]').val(data.name_slider);
